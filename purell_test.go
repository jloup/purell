...
func TestEncodeNecessaryEscapesAll(t *testing.T) {
	...
	if s, e := NormalizeURLString(url, FlagEncodeNecessaryEscapes); e != nil {
		...
		t.Error("EncodeNecessaryEscapesAll")
	}
}
